...
public class Calculator/*@bgen(jjtree)*/implements CalculatorTreeConstants, CalculatorConstants {/*@bgen(jjtree)*/
  protected static JJTCalculatorState jjtree = new JJTCalculatorState();public static HashMap<String, Integer> map = new HashMap<String, Integer>();
 ...
 public static void main(String args[]) throws ParseException {
        ...
        System.out.println("Valor da express\u00c3\u00a3o: "+myCalc.eval(root));
 }
 ...
 int eval(SimpleNode node) {
  ...
  static final public SimpleNode Expression() throws ParseException {/*@bgen(jjtree) Expression */
                          ...
                          jjtree.openNodeScope(jjtn000);Token k,v;
    try {
      label_1:
      while (true) {
        if (jj_2_1(2)) {
        ...
        k = jj_consume_token(SYMBOL);
        jj_consume_token(7);
        v = jj_consume_token(INTEGER);
map.put(k.image,Integer.parseInt(v.image));
        jj_consume_token(8);
        jj_consume_token(LF);
      }
      Expr1();
...
jjtree.closeNodeScope(jjtn001, true);
                                                                            jjtc001 = false;
jjtn001.val = sign * map.get(t.image);
        } else {
          jj_consume_token(-1);
          throw new ParseException();
        }
